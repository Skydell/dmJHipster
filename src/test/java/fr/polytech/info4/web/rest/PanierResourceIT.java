...
public class PanierResourceIT {
    ...
    private static final String DEFAULT_LISTELEMENTS = "AAAAAAAAAA";
    private static final String UPDATED_LISTELEMENTS = "BBBBBBBBBB";
    ...
    public static Panier createEntity(EntityManager em) {
        Panier panier = new Panier()
            ...
            .listelements(DEFAULT_LISTELEMENTS)
            .price(DEFAULT_PRICE);
        return panier;
    }
    /**
    ...
    public static Panier createUpdatedEntity(EntityManager em) {
        Panier panier = new Panier()
            ...
            .listelements(UPDATED_LISTELEMENTS)
            .price(UPDATED_PRICE);
        return panier;
    }
    ...
    public void createPanier() throws Exception {
        ...
        assertThat(testPanier.getListelements()).isEqualTo(DEFAULT_LISTELEMENTS);
    ...
    public void getAllPaniers() throws Exception {
        ...
        restPanierMockMvc.perform(get("/api/paniers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].listelements").value(hasItem(DEFAULT_LISTELEMENTS)))
    ...
    public void getPanier() throws Exception {
        ...
        restPanierMockMvc.perform(get("/api/paniers/{id}", panier.getId()))
            ...
            .andExpect(jsonPath("$.listelements").value(DEFAULT_LISTELEMENTS))
    ...
    public void updatePanier() throws Exception {
        ...
        assertThat(testPanier.getListelements()).isEqualTo(UPDATED_LISTELEMENTS);
