...
describe('Roles e2e test', () => {
  ...
  it('should load Roles', async () => {
    ...
    expect(await rolesComponentsPage.getTitle()).to.eq('dmJHipsterApp.roles.home.title');
  ...
  it('should load create Roles page', async () => {
    ...
    expect(await rolesUpdatePage.getPageTitle()).to.eq('dmJHipsterApp.roles.home.createOrEditLabel');
  ...
  it('should delete last Roles', async () => {
    ...
    expect(await rolesDeleteDialog.getDialogTitle()).to.eq('dmJHipsterApp.roles.delete.question');
