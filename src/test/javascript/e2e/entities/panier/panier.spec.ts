...
describe('Panier e2e test', () => {
  ...
  it('should load Paniers', async () => {
    ...
    expect(await panierComponentsPage.getTitle()).to.eq('dmJHipsterApp.panier.home.title');
  ...
  it('should load create Panier page', async () => {
    ...
    expect(await panierUpdatePage.getPageTitle()).to.eq('dmJHipsterApp.panier.home.createOrEditLabel');
  ...
  it('should create and save Paniers', async () => {
    ...
    await promise.all([
      ...
      panierUpdatePage.setListelementsInput('listelements'),
    ...
    expect(await panierUpdatePage.getListelementsInput()).to.eq('listelements', 'Expected Listelements value to be equals to listelements');
  ...
  it('should delete last Panier', async () => {
    ...
    expect(await panierDeleteDialog.getDialogTitle()).to.eq('dmJHipsterApp.panier.delete.question');
