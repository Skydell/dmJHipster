...
describe('Compte e2e test', () => {
  ...
  it('should load Comptes', async () => {
    ...
    expect(await compteComponentsPage.getTitle()).to.eq('dmJHipsterApp.compte.home.title');
  ...
  it('should load create Compte page', async () => {
    ...
    expect(await compteUpdatePage.getPageTitle()).to.eq('dmJHipsterApp.compte.home.createOrEditLabel');
  ...
  it('should delete last Compte', async () => {
    ...
    expect(await compteDeleteDialog.getDialogTitle()).to.eq('dmJHipsterApp.compte.delete.question');
